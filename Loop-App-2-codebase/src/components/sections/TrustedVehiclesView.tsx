    ...
    <div className="flex flex-col h-full pt-2">
      <div className="flex items-center justify-between mb-4 px-1">
        <div className="flex items-center gap-3">
          <button onClick={() => setView("profile")} className={`w-8 h-8 rounded-full ${cardBg} border ${border} flex items-center justify-center active:scale-90`}>
            <ArrowLeft size={16} />
          </button>
        ...
        <button 
          ...
          className="bg-[#FFC554] text-black w-9 h-9 rounded-full flex items-center justify-center shadow-lg active:scale-90"
        >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-2">
                  {v.profiles?.avatar_url ? (
                    <img src={v.profiles.avatar_url} className="w-4 h-4 rounded-full object-cover" />
                  ) : (
